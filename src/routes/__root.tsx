...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Gebze Hacıhalil'de profesyonel erkek kuaförü. Saç, sakal, cilt bakımı." },
      { property: "og:title", content: "Kafadar Erkek Kuaförü — Gebze'nin Adresi" },
      { property: "og:description", content: "Gebze Hacıhalil'de profesyonel erkek kuaförü. Saç, sakal, cilt bakımı." },
      { property: "og:type", content: "website" },
      { name: "twitter:title", content: "Kafadar Erkek Kuaförü — Gebze'nin Adresi" },
      { name: "twitter:description", content: "Gebze Hacıhalil'de profesyonel erkek kuaförü. Saç, sakal, cilt bakımı." },
