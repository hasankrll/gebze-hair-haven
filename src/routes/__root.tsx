...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "Kafadar Erkek Kuaförü | Gebze Erkek Kuaförü" },
      { name: "twitter:description", content: "Gebze'nin en iyi erkek kuaförü. Saç kesimi, sakal, fön ve daha fazlası. Randevu için WhatsApp: 0538 371 50 57" },
